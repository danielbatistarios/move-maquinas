...
const body = readFileSync('/Users/jrios/move-maquinas-site/blog/andaime-vs-plataforma-custo-real/index.html');
const url = `${ENDPOINT}/pages/move/blog/andaime-vs-plataforma-custo-real/index.html`;
const res = await client.fetch(url, { method: 'PUT', body, headers: { 'Content-Type': 'text/html; charset=utf-8' } });
console.log(res.ok ? 'Upload OK!' : `Error: ${res.status}`);
console.log('https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/move/blog/andaime-vs-plataforma-custo-real/index.html');
