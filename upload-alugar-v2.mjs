...
const body = readFileSync('/Users/jrios/move-maquinas-seo/blog-alugar-ou-comprar-final-v2.html');
const url = `${ENDPOINT}/${BUCKET}/move/blog/alugar-ou-comprar/index.html`;
...
console.log('URL: https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/move/blog/alugar-ou-comprar/index.html');
