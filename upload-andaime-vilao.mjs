...
const body = readFileSync('/Users/jrios/move-maquinas-seo/blog-andaime-vilao-publicar.html');
const url = `${ENDPOINT}/pages/move/blog/andaime-vilao-cronograma-obra/index.html`;
...
console.log('https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/move/blog/andaime-vilao-cronograma-obra/index.html');
