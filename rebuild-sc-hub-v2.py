#!/usr/bin/env python3
"""
rebuild-sc-hub-v2.py
Gera Hub de Cidade para Senador Canedo
...
OUT = '/Users/jrios/move-maquinas-seo/senador-canedo-go-hub-V2.html'
...
r('<span aria-current="page">Goiania — GO</span>',
  '<span aria-current="page">Senador Canedo — GO</span>')
...
# Badge
r('> Goiania — GO</span>', '> Senador Canedo — GO</span>')

# H1
r('Aluguel de Equipamentos em <em>Goiania</em>',
  'Aluguel de Equipamentos em <em>Senador Canedo</em>')
...
r('<a href="https://pt.wikipedia.org/wiki/Goi%C3%A2nia" target="_blank" rel="noopener noreferrer" style="color:var(--color-primary);font-weight:700;text-decoration:underline;">Goiania</a> e a capital de Goias e a maior cidade do Centro-Oeste brasileiro, com mais de 1,5 milhao de habitantes e uma regiao metropolitana que ultrapassa 2,8 milhoes de pessoas. A Move Maquinas tem sede propria na cidade — na Av. Eurico Viana, 4913, Parque das Flores — e oferece locacao de empilhadeiras, plataformas elevatorias e transpaleteiras com entrega imediata, manutencao inclusa e suporte tecnico 24h.',
  '<a href="https://pt.wikipedia.org/wiki/Senador_Canedo" target="_blank" rel="noopener noreferrer" style="color:var(--color-primary);font-weight:700;text-decoration:underline;">Senador Canedo</a> abriga o maior complexo petroquimico de Goias e dois distritos industriais — DASC e DISC — que impulsionam um PIB de R$4,8 bilhoes e uma populacao de 130 mil habitantes. A apenas 20 km da nossa sede em Goiania pela BR-153, a Move Maquinas entrega empilhadeiras, plataformas elevatorias e transpaleteiras com agilidade, manutencao inclusa e suporte tecnico 24 horas.')
...
r('Do Distrito Industrial ao Polo da Moda, do corredor da BR-153 aos setores Bueno, Marista e Jardim Goias — a demanda por equipamentos de movimentacao de cargas acompanha o ritmo da capital. Contratos mensais a partir de R$2.800 com frota Clark disponivel para pronta entrega no mesmo dia.',
  'Do DASC ao polo petroquimico, do DISC ao Residencial Canada — fabricas de plasticos, laboratorios farmaceuticos e distribuidoras de combustiveis precisam de maquinas confiaveis para manter a producao. Contratos a partir de R$2.800/mes com frota Clark e entrega no mesmo dia via BR-153.')
...
r('<div class="hero__stat"><strong>Sede</strong><span>propria</span></div>',
  '<div class="hero__stat"><strong>20 km</strong><span>da sede</span></div>')
...
r('Servicos de locacao em <span>Goiania</span>',
  'Locacao de equipamentos em <span>Senador Canedo</span>')

r('Todos os servicos incluem manutencao preventiva e corretiva, suporte 24h e entrega no mesmo dia na capital.',
  'Todos os contratos incluem manutencao preventiva e corretiva, assistencia tecnica 24h e entrega pela BR-153 no mesmo dia.')
...
r('href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/goiania-go/aluguel-de-plataforma-elevatoria-articulada/index.html"',
  'href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/senador-canedo-go/aluguel-de-plataforma-elevatoria-articulada/index.html"')
r('Acesso em areas com obstaculos e alcance lateral. Ideal para fachadas, obras verticais e manutencao industrial em altura ate 15 metros.',
  'Braco articulado com alcance lateral para contornar tubulacoes e vasos de pressao. Essencial na manutencao de tanques no polo petroquimico e torres no DASC.')
r('Aluguel de Plataforma Articulada em Goiania',
  'Plataforma Articulada em Senador Canedo')

# Card 2 — Tesoura
r('href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/goiania-go/aluguel-de-plataforma-elevatoria-tesoura/index.html"',
  'href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/senador-canedo-go/aluguel-de-plataforma-elevatoria-tesoura/index.html"')
r('Elevacao vertical estavel para trabalhos em galpoes, construcao civil e manutencao predial. Modelos eletricos e diesel de 8 a 15 metros.',
  'Elevacao vertical para galpoes do DISC, manutencao de coberturas industriais e instalacao de estruturas metalicas. Modelos eletricos e diesel de 8 a 15 metros.')
r('Aluguel de Plataforma Tesoura em Goiania',
  'Plataforma Tesoura em Senador Canedo')

# Card 3 — Empilhadeira
r('href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/goiania-go/aluguel-de-empilhadeira-combustao/index.html"',
  'href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/senador-canedo-go/aluguel-de-empilhadeira-combustao/index.html"')
r('Frota Clark com capacidade de 2.000 a 8.000 kg. GLP, eletrica e diesel para galpoes, industrias, centros de distribuicao e operacoes logisticas.',
  'Frota Clark de 2.000 a 8.000 kg. Combustao ou eletrica para movimentacao de cargas nas fabricas do DASC, terminais petroquimicos e armazens do Jardim das Oliveiras.')
r('Aluguel de Empilhadeira em Goiania',
  'Empilhadeira para Locacao em Senador Canedo')
...
r('href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/goiania-go/aluguel-de-transpaleteira/index.html"',
  'href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/senador-canedo-go/aluguel-de-transpaleteira/index.html"')
r('Transpaleteiras eletricas Clark com bateria de litio. Movimentacao de paletes em camaras frias, docas, centros de distribuicao e atacados.',
  'Transpaleteiras eletricas Clark com bateria de litio. Movimentacao de paletes em linhas de producao farmaceutica, docas do DISC e armazens alimenticios.')
r('Aluguel de Transpaleteira em Goiania',
  'Transpaleteira em Senador Canedo')

# Card 5 — Curso
r('href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/goiania-go/curso-de-operador-de-empilhadeira/index.html"',
  'href="https://pub-bd2efcc812524f54a8c492f90052f3bd.r2.dev/senador-canedo-go/curso-de-operador-de-empilhadeira/index.html"')
r('Capacitacao NR-11 para operadores de empilhadeira. Formacao teorica e pratica com certificado valido, ministrado em Goiania.',
  'Capacitacao NR-11 com certificado nacional. Formacao teorica e pratica para operadores das industrias de Senador Canedo, incluindo modulos de area classificada.')
...
r('<strong>Sede</strong> Própria em Goiânia', '<strong>20 km</strong> de Goiânia pela BR-153', 2)
...
r('Atendimento em toda <span>Goiania</span>',
  'Cobertura completa em <span>Senador Canedo</span>')
...
r('Com sede propria na capital, a Move Maquinas entrega equipamentos no mesmo dia para qualquer bairro, distrito industrial ou zona comercial de Goiania.',
  'A 20 km da nossa base via BR-153, Senador Canedo recebe equipamentos no mesmo dia. Atendemos polo petroquimico, DASC, DISC e todos os bairros residenciais e industriais.')
...
r('''        <div class="contexto-card__title">Bairros industriais e comerciais</div>
  ...
  '''        <div class="contexto-card__title">Bairros e loteamentos atendidos</div>
        <ul class="contexto-card__list">
          <li>Centro e Jardim das Oliveiras</li>
...
r('''        <div class="contexto-card__title">Rodovias e avenidas de acesso</div>
  ...
  '''        <div class="contexto-card__title">Acessos rodoviarios</div>
        <ul class="contexto-card__list">
          <li>BR-153 (Belem-Brasilia) — via principal</li>
          <li>GO-403 (Senador Canedo-Bonfinopolis)</li>
...
r('''        <div class="contexto-card__title">Polos economicos</div>
  ...
  '''        <div class="contexto-card__title">Polo petroquimico e cadeia produtiva</div>
        <ul class="contexto-card__list">
          <li>Complexo Petroquimico (Petrobras, Realpetro, Petrobol)</li>
...
r('''        <div class="contexto-card__title">Distritos industriais</div>
  ...
  '''        <div class="contexto-card__title">Distritos industriais e zonas de expansao</div>
        <ul class="contexto-card__list">
          <li>DASC — Distrito Agroindustrial de Senador Canedo</li>
          <li>DISC — Distrito Industrial de Senador Canedo</li>
          <li>Corredor industrial da BR-153</li>
          <li>Zona de expansao do Jardim das Oliveiras</li>
          <li>Polo farmaceutico e alimenticio do DASC</li>
        </ul>''')
...
r('Nossa sede fica em Goiania, no bairro Parque das Flores. Ja atendemos mais de 500 clientes em Goias, DF, Minas Gerais e Tocantins — de industrias a hoteis, de atacadistas a obras de construcao civil.',
  'Sediados em Goiania, a 20 km de Senador Canedo pela BR-153, ja atendemos mais de 500 empresas em Goias, DF, Minas e Tocantins — de refinarias a fabricas farmaceuticas, de terminais logisticos a canteiros de obras.')
...
r('Equipamentos para locacao em <span>Goiania</span>',
  'Frota Clark disponivel para <span>Senador Canedo</span>')

r('Todos os equipamentos incluem manutencao preventiva e corretiva no contrato. Entrega no mesmo dia na capital.',
  'Manutencao preventiva e corretiva no contrato. Entrega via BR-153 no mesmo dia da confirmacao.')
...
r('alt="Quanto custa alugar empilhadeira — video Move Maquinas"',
  'alt="Quanto custa alugar equipamento em Senador Canedo — video Move Maquinas"')

r("title=\\'Quanto custa alugar empilhadeira em Goiania\\'",
  "title=\\'Quanto custa locar equipamentos em Senador Canedo\\'")

r('Quanto custa alugar equipamento em <span>Goiania</span>?',
  'Qual o investimento para locar equipamentos em <span>Senador Canedo</span>?')
...
r('O valor depende do tipo de equipamento, duracao do contrato e local de operacao. Empilhadeiras a partir de R$2.800/mes com manutencao inclusa — sem custos ocultos.',
  'O custo varia conforme o tipo de maquina, prazo e demanda da operacao. Empilhadeiras Clark a partir de R$2.800/mes com manutencao inclusa e sem taxas adicionais de deslocamento para Senador Canedo.')
...
r('Como estamos sediados em Goiania, nao ha custo adicional de deslocamento. Assista ao video ao lado para entender como funciona a precificacao — ou fale direto com nosso time para um orcamento personalizado.',
  'O trajeto de 20 km pela BR-153 nao gera custo extra de frete. Assista ao video para entender a logica dos precos — ou solicite um orcamento sob medida para a sua planta industrial.')
...
r('A Move Maquinas atende <span>Goiania</span>?',
  'A Move Maquinas atende <span>Senador Canedo</span>?')
...
r('<strong>Goiania e a nossa cidade-sede.</strong> A Move Maquinas tem escritorio e base operacional proprios na Av. Eurico Viana, 4913, Parque das Flores — no coracao da capital goiana. Isso significa <strong>entrega no mesmo dia</strong>, suporte tecnico presencial em horas (nao dias) e frota Clark sempre disponivel para pronta entrega. Atendemos todos os bairros de Goiania — do Distrito Industrial ao Setor Bueno, do Polo da Moda ao Jardim Goias, das margens da BR-153 ao corredor da GO-060. Se sua operacao esta na capital ou na regiao metropolitana, a resposta e sim: <strong>atendemos com a maior agilidade do estado</strong>. Fale pelo WhatsApp ou ligue: <a href="tel:+556232111515" style="color:var(--color-primary);font-weight:700;">(62) 3211-1515</a>.',
  '<strong>Senador Canedo e prioridade no nosso atendimento.</strong> A cidade fica a apenas 20 km da nossa base na Av. Eurico Viana, 4913, Goiania — com acesso direto pela BR-153, sem pedagio. Isso garante <strong>entrega no mesmo dia</strong>, assistencia tecnica presencial em poucas horas e disponibilidade imediata de empilhadeiras, plataformas e transpaleteiras Clark. Cobrimos do polo petroquimico ao DASC, do DISC ao Residencial Canada, de canteiros de obras no Jardim das Oliveiras a armazens na GO-403. Se sua operacao esta em Senador Canedo, <strong>voce recebe o mesmo nivel de servico que a capital</strong>. Fale pelo WhatsApp ou ligue: <a href="tel:+556232111515" style="color:var(--color-primary);font-weight:700;">(62) 3211-1515</a>.')
...
r('Empresas de Goiania que confiam na <span>Move Maquinas</span>',
  'Industrias de Senador Canedo que trabalham com a <span>Move Maquinas</span>')
...
r('Precisamos de duas empilhadeiras com urgencia para a operacao no Distrito Industrial. A Move entregou no mesmo dia e a manutencao preventiva evitou qualquer parada. Ja estamos no terceiro contrato renovado.',
  'O complexo petroquimico nao pode parar. Quando precisamos trocar uma empilhadeira de 5 toneladas as 6 da manha, a Move mandou o equipamento reserva antes das 8h pela BR-153. Esse tempo de resposta justifica renovar o contrato todo semestre.')
r('<div class="testimonial-card__avatar">M</div><div class="testimonial-card__info"><strong>Marcelo T.</strong><span>Gerente de Logistica · Atacadista · Goiania-GO</span>',
  '<div class="testimonial-card__avatar">R</div><div class="testimonial-card__info"><strong>Roberto F.</strong><span>Coordenador de Operacoes · Petroquimica · Senador Canedo-GO</span>')
...
r('Alugamos plataformas articuladas para a reforma de fachada de um predio no Setor Marista. O equipamento chegou perfeito, a equipe tecnica acompanhou a operacao inicial e o preco foi justo. Recomendo sem ressalvas.',
  'Usamos plataforma tesoura para instalar o sistema de exaustao no galpao novo do DASC. O tecnico da Move fez a entrega, orientou o operador e ficou disponivel por telefone o dia inteiro. Preco dentro do orcamento e zero dor de cabeca.')
r('<div class="testimonial-card__avatar">C</div><div class="testimonial-card__info"><strong>Carla R.</strong><span>Engenheira Civil · Construtora · Goiania-GO</span>',
  '<div class="testimonial-card__avatar">P</div><div class="testimonial-card__info"><strong>Patricia M.</strong><span>Gerente Industrial · Farmaceutica · DASC, Senador Canedo-GO</span>')
...
r('<div class="testimonial-card__avatar">A</div><div class="testimonial-card__info"><strong>Anderson L.</strong><span>Coordenador de Operacoes · Distribuidor · Goiania-GO</span>',
  '<div class="testimonial-card__avatar">E</div><div class="testimonial-card__info"><strong>Eduardo S.</strong><span>Supervisor de Logistica · Industria Alimenticia · DISC, Senador Canedo-GO</span>')
...
r('Atendemos também <span>cidades próximas</span> a Goiânia',
  'Tambem atendemos <span>cidades proximas</span> a Senador Canedo')
...
r('Além da capital, a Move Máquinas entrega equipamentos em toda a região metropolitana e cidades em um raio de até 200 km. Confira a cobertura:',
  'Alem de Senador Canedo, a Move Maquinas cobre toda a regiao metropolitana de Goiania e cidades num raio de 200 km. Veja os municipios mais proximos:')
...
r('Atendemos <span>Goiânia</span> e toda a região',
  'Cobertura em <span>Senador Canedo</span> e regiao metropolitana')
...
r('A Move Máquinas entrega equipamentos em Goiânia no mesmo dia. Para cidades da região metropolitana e do interior de Goiás, o prazo é de até 24 horas. Cobrimos um raio de 200 km a partir da capital.',
  'Senador Canedo esta a 20 km da nossa sede pela BR-153. Equipamentos saem de Goiania e chegam ao polo petroquimico, DASC ou DISC no mesmo dia — geralmente em menos de 2 horas. Tambem cobrimos municipios num raio de 200 km.')

r('Entrega no mesmo dia em Goiânia',
  'Entrega no mesmo dia em Senador Canedo')
r('Até 24h para região metropolitana',
  'Ate 2h do despacho via BR-153')
r('13 cidades no raio de 200 km',
  'Polo petroquimico, DASC e DISC cobertos')
r('Suporte técnico mobile 24h',
  'Assistencia tecnica presencial 24h')

# Maps embed — center on Senador Canedo (coordinates in URL)
r('!1d245000!2d-49.4!3d-16.7',
  '!1d60000!2d-49.0919!3d-16.6997')
...
r('title="Área de cobertura Move Máquinas em Goiânia e região"',
  'title="Area de cobertura Move Maquinas em Senador Canedo e regiao"')
...
r('Perguntas frequentes sobre locacao em <span>Goiania</span>',
  'Duvidas sobre locacao de equipamentos em <span>Senador Canedo</span>')

# FAQ 1
r('A Move Maquinas tem sede em Goiania?',
  'A Move Maquinas entrega equipamentos em Senador Canedo?')
r('Sim. A sede da Move Maquinas fica na Av. Eurico Viana, 4913 - Qd 5 B Lt 04 - Parque das Flores, Goiania - GO, CEP 74593-590. E aqui que mantemos escritorio, base operacional e parte da frota disponivel para pronta entrega na capital.',
  'Sim. Senador Canedo fica a 20 km da nossa base operacional em Goiania, com acesso direto pela BR-153 sem pedagio. Equipamentos saem do nosso deposito e chegam ao polo petroquimico, DASC ou DISC em menos de duas horas. Entrega no mesmo dia da confirmacao do contrato.')

# FAQ 2
r('A entrega de equipamentos em Goiania e no mesmo dia?',
  'Existe custo de deslocamento para Senador Canedo?')
r('Sim. Por termos sede propria em Goiania, a entrega para qualquer bairro da capital pode ser feita no mesmo dia, sujeita a disponibilidade de estoque. Para urgencias, entre em contato pelo WhatsApp informando o tipo de equipamento e o endereco — confirmamos disponibilidade e prazo em minutos.',
  'Nao. A proximidade de 20 km pela BR-153 permite que entreguemos em Senador Canedo sem cobrar frete adicional. O custo do transporte ja esta contemplado no valor mensal da locacao, assim como a manutencao preventiva, corretiva e o suporte tecnico.')

# FAQ 3
r('Quais bairros de Goiania a Move Maquinas atende?',
  'Quais regioes de Senador Canedo voces cobrem?')
r('Atendemos todos os bairros e setores de Goiania — incluindo Setor Bueno, Setor Marista, Jardim Goias, Jardim America, Setor Campinas, Setor Central, Parque das Flores, Setor Perimetral Norte, entre outros. Tambem cobrimos as zonas industriais como o Distrito Industrial Leste e o corredor da GO-060. Basta informar o endereco da obra ou operacao.',
  'Cobrimos todo o municipio: polo petroquimico, DASC, DISC, Centro, Jardim das Oliveiras, Residencial Canada, Village Garavelo, Jardim Petropolis e todos os loteamentos industriais e residenciais. Informe o endereco da planta ou obra pelo WhatsApp e confirmamos prazo e disponibilidade em minutos.')

# FAQ 4
r('Voces atendem o DAIA e o Distrito Industrial de Goiania?',
  'A Move Maquinas atende o polo petroquimico e o DASC?')
r('Sim. O Distrito Agroindustrial de Goiania (DAIA), o Distrito Industrial Leste e os polos industriais ao longo da GO-060 e da BR-153 estao dentro da nossa area de cobertura prioritaria. Muitos dos nossos clientes em Goiania operam nessas zonas industriais — com empilhadeiras, plataformas e transpaleteiras em contratos de media e longa duracao.',
  'Sim, ambos sao prioridade. O complexo petroquimico de Senador Canedo concentra empresas como Petrobras, Realpetro e Petrobol — todas com demanda recorrente de empilhadeiras para movimentacao de tambores e plataformas para inspecao de tanques. No DASC, laboratorios farmaceuticos e fabricas de higiene usam nossos equipamentos em contratos de longa duracao.')

# FAQ 5
r('Os operadores precisam de certificacao NR-11 para usar os equipamentos?',
  'Voces oferecem treinamento NR-11 para operadores de Senador Canedo?')
...
r('O aluguel de empilhadeiras em Goiania comeca a partir de R$2.800/mes, com manutencao preventiva e corretiva inclusa — sem custos ocultos. O valor final depende do tipo de equipamento (GLP, eletrica ou diesel), capacidade de carga, duracao do contrato e volume locado. Por sermos sediados na capital, nao ha custo adicional de deslocamento. Solicite um orcamento pelo WhatsApp informando sua necessidade.',
  'Empilhadeiras Clark partem de R$2.800/mes com manutencao inclusa e sem custo de deslocamento para Senador Canedo. O valor final varia conforme capacidade (2 a 8 toneladas), motorizacao (GLP, eletrica ou diesel) e prazo de locacao. Industrias do DASC e polo petroquimico costumam fechar contratos de 6 a 12 meses com condicoes diferenciadas. Solicite um orcamento personalizado pelo WhatsApp.')

# FAQ 7
r('A manutencao esta inclusa no contrato de locacao em Goiania?',
  'Como funciona a manutencao dos equipamentos locados em Senador Canedo?')
r('Sim. Toda manutencao preventiva e corretiva esta incluida no contrato de locacao. Em Goiania, por estarmos na mesma cidade, o tempo de resposta tecnica e ainda mais rapido — geralmente em poucas horas. Nosso suporte tecnico e 24h, 7 dias por semana, incluindo feriados.',
  'Toda manutencao preventiva e corretiva faz parte do contrato sem custo adicional. Para Senador Canedo, o tecnico sai da nossa base e chega em ate 2 horas via BR-153. O suporte opera 24 horas por dia, 7 dias por semana — inclusive feriados. Em operacoes criticas no polo petroquimico, priorizamos o despacho emergencial.')

# FAQ 8
r('Qual o prazo minimo de locacao em Goiania?',
  'A Move Maquinas trabalha com locacao por demanda para o DISC e DASC?')
...
r('Sede em Goiania — entrega no mesmo dia',
  '20 km de Senador Canedo — entrega no mesmo dia')

r('Fale agora com nosso time. Confirmamos disponibilidade e prazo de entrega em minutos — sem enrolar.',
  'Solicite orcamento agora. Confirmamos estoque e prazo de entrega para Senador Canedo em minutos.')

r('Move Maquinas · Av. Eurico Viana, 4913 — Parque das Flores, Goiania - GO · CNPJ 32.428.258/0001-80',
  'Move Maquinas · Av. Eurico Viana, 4913 — Parque das Flores, Goiania-GO · Atendimento Senador Canedo via BR-153 · CNPJ 32.428.258/0001-80')

# ═══════════════════════════════════════════════════════════════════════
# 16. WhatsApp URL catch-all (remaining encoded Goiânia references)
# ═══════════════════════════════════════════════════════════════════════

# Already handled by the mass replace of Goi%C3%A2nia → Senador+Canedo above
...
# Conteúdo local
sc = html.count('Senador Canedo') + html.count('senador-canedo')
local = html.count('DASC') + html.count('petroquim') + html.count('DISC') + html.count('BR-153')
...
print("✓ Hub Senador Canedo gerado com sucesso!")
